      ...
      <Flex direction="column">
        ...
        <SimpleGrid columns={["1", "1", "2", "2", "2"]} placeItems={["center", "center", "normal", "normal"]} >
          <Link href="https://spline.design/" isExternal>
            <Image
              ...
              boxSize={["150px", "150px", "200px", "200px", "250px"]}
            />
          </Link>
        </ SimpleGrid>

        {/* Platinum Tier Start */}
        <Stack py="20px" direction="row" alignItems="center" spacing={["5", "8", "8", "8"]} >
          <Heading
            fontWeight="normal"
            fontSize={["2xl", "2xl", "2xl", "2xl", "2xl"]}
            color="#c7c7c7"
        ...
        <SimpleGrid columns={["1", "1", "2", "2", "2"]} py="20px" placeItems="center">
          <Link href="https://graphcms.com" isExternal>
            <Image src="https://res.cloudinary.com/emishalabs/image/upload/v1613043913/UtkalHacks%203.0/GraphCMS_Logo.webp"
              w={["300px", "300px", "500px", "500px", "500px"]} />
          </Link>
        </SimpleGrid>
        ...
        <Stack direction="row" alignItems="center" py="20px" >
          <Heading
            fontWeight="normal"
            fontSize={["2xl", "2xl", "2xl", "2xl", "2xl"]}
            color="#f86ca1"
        ...
        <SimpleGrid columns={["1", "1", "3", "3", "3"]} gap={10} py="20px" placeItems="center">
