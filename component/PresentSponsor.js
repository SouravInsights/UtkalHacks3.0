...
function PresentSponsor() {
  return (
    <Box my="80px">
      ...
      <SimpleGrid columns={["1", "1", "2", "2", "2"]} py="20px" placeItems="center" gap={10}>
        <Link _focus={{ boxShadow: "none" }} href="https://graphcms.com" isExternal>
          <Image
      ...
      <SimpleGrid columns={["2", "2", "3", "3", "3"]} py="20px" placeItems="center" gap={10}>
        ...
        <Link _focus={{ boxShadow: "none" }} href="https://nhost.io/" isExternal>
          <Image
        ...
        <Link _focus={{ boxShadow: "none" }} href="https://tezos.com/" isExternal>
          <Image
      ...
      <SimpleGrid columns={["1", "1", "3", "3", "3"]} gap={10} placeItems="center">
        ...
        <Link _focus={{ boxShadow: "none" }} href="https://egghead.io/" isExternal>
